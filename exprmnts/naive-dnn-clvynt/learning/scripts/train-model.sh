...
#CUDA_VISIBLE_DEVICES="0" $BIN/deep_quant.py --config=config/rnn.conf    --train=True --datafile=source-ml-data-100M-train.dat > output/ouput-rnn-train.txt    2> stderr-train.txt  ;
