...
CUDA_VISIBLE_DEVICES="0" $BIN/deep_quant.py --config=config/dnn.conf    --train=False --datafile=source-ml-data-100M.dat --pretty_print_preds=False > output/predicts-dnn.dat           2> stderr-dnn.txt    ;
