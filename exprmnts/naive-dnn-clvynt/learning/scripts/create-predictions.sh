...
CUDA_VISIBLE_DEVICES="" $BIN/deep_quant.py --config=config/mlp.conf    --train=False --datafile=source-ml-data-100M.dat --pretty_print_preds=False > output/predicts-mlp.dat           2> stderr-mlp.txt    ;
